...
#define STRING_CONFIG_H_AUTHOR "Steve Kelly Mendel 90" // Who made the changes.
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Ultimaker
  #define  DEFAULT_Kp 46.96
  #define  DEFAULT_Ki 4.30
  #define  DEFAULT_Kd 128.10
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 4000, 240}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {300, 300, 3.5, 25}    // (mm/sec)
